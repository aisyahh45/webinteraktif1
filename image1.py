...
def main():
    unggah_gambar = st.file_uploader('Pilih Gambar:', type=["jpg","jpeg","png","webp"])
    if unggah_gambar is not None:
        gambar = Image.open(unggah_gambar)
        #Untuk memebuat 2 kolom yang lebarnya sama 
        kolom1, kolomtengah, kolom2 = st.columns(3)
        pilih_filter = kolomtengah.selectbox("Pilih Jenis Filter",["BLUR","CONTOUR","EMBOSS","SHARPEN","SMOOTH"])
